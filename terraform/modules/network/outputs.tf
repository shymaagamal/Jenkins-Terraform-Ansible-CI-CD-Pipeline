...
output "networkOUT_public_subnet01_id" {
  value = aws_subnet.network_public_subnet01.id
  description = "The id of public subnet"
}
output "networkOUT_public_subnet02_id" {
  value = aws_subnet.network_public_subnet02.id
  description = "The id of public subnet"
}
...
output "networkOUT_albSG_allow_HTTP" {
  value = aws_security_group.network_albSG_allow_HTTP.id
